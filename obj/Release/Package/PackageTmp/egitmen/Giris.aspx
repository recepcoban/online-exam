<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giris.aspx.cs" Inherits="SinavSistemi.egitmen.Giris" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8" />
    <title>WTSS - Eğitmen Girişi</title>
                                ...
                                <div class="col-lg-8 col-lg-offset-2 text-left">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="updateGiris">
                                        <ContentTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Bu Alan Boş Geçilemez!" ControlToValidate="txtKadi" runat="server" ValidationGroup="yonGiris" ForeColor="Red" Font-Size="Small" Font-Bold="true" />
                                            <br />
                                            <asp:TextBox ID="txtParola" TextMode="Password" runat="server" CssClass="form-control" placeholder="Parola" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="Bu Alan Boş Geçilemez!" ControlToValidate="txtParola" runat="server" ValidationGroup="yonGiris" ForeColor="Red" Font-Size="Small" Font-Bold="true" />
                                            <br />
